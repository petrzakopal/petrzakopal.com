...
export const NoteCard = ({ note }: { note: Note }) => {
	...
	return (
		<>
			<Link
				href={note.url}
				className="w-full flex flex-col text-start items-start justify-start text-black dark:text-light-white transition-all ease-in-out px-3 p-2.5 rounded-lg bg-zinc-100 hover:bg-zinc-200  dark:bg-neutral-900 dark:hover:bg-neutral-800"
			>
